...
class NottingHill extends StatefulWidget {
  const NottingHill({super.key});

  @override
  State<NottingHill> createState() => _NottingHillState();
}

class _NottingHillState extends State<NottingHill> {
  @override
              ...
              child: Column(
                children: [
                  ...
                  const Padding(
                    ...
                    child: Text(
                      " William vit à Notting Hill, à l'ouest de Londres. Divorcé, ce trentenaire mène une existence paisible entre sa librairie et la maison qu'il partage avec Spike, un ami.",
                      style: TextStyle(
                        color: Colors.white,
                      ),
                    ),
