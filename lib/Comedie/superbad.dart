...
class Superbad extends StatefulWidget {
  const Superbad({super.key});

  @override
  State<Superbad> createState() => _SuperbadState();
}

class _SuperbadState extends State<Superbad> {
  @override
              ...
              child: Column(
                children: [
                  ...
                  const Padding(
                    ...
                    child: Text(
                      " Deux meilleurs amis inséparables naviguent dans les dernières semaines du secondaire et sont invités à une gigantesque fête.",
                      style: TextStyle(
                        color: Colors.white,
                      ),
                    ),
