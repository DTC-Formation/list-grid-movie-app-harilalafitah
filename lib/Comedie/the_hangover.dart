...
class TheHangover extends StatefulWidget {
  const TheHangover({super.key});

  @override
  State<TheHangover> createState() => _TheHangoverState();
}

class _TheHangoverState extends State<TheHangover> {
  @override
              ...
              child: Column(
                children: [
                  ...
                  const Padding(
                    ...
                    child: Text(
                      " Trois jeunes hommes cherchent un ami qui a disparu au cours d'une super fête à Las Vegas. Le trio doit tenter de se souvenir de toutes les mauvaises décisions prises la veille afin de retrouver leur ami et le ramener à temps pour son mariage prévu à Los Angeles.",
                      style: TextStyle(
                        color: Colors.white,
                      ),
                    ),
