...
class GranTurismo extends StatefulWidget {
  const GranTurismo({super.key});

  @override
  State<GranTurismo> createState() => _GranTurismoState();
}

class _GranTurismoState extends State<GranTurismo> {
  @override
              ...
              child: Column(
                children: [
                  ...
                  const Padding(
                    ...
                    child: Text(
                      " La jeune Jann Mardenborough meurt d'envie d'être pilote de course, mais n'a pas les moyens financiers de faire partie du sport d'élite.\n C'est pourquoi il n'a appuyé sur l'accélérateur que dans le jeu vidéo Gran Turismo et a connu un énorme succès.",
                      style: TextStyle(
                        color: Colors.white,
                      ),
                    ),
