...
class TokyoDrift extends StatefulWidget {
  const TokyoDrift({super.key});

  @override
  State<TokyoDrift> createState() => _TokyoDriftState();
}

class _TokyoDriftState extends State<TokyoDrift> {
  @override
              ...
              child: Column(
                children: [
                  ...
                  const Padding(
                    ...
                    child: Text(
                      " Se sentant étranger dans son environnement, un jeune homme (Lucas Black) se définit par ses victoires à la course de rue. Cette activité le rendant impopulaire auprès des autorités, il part vivre au Japon avec son père.\n Il apprend que ce genre de course y existe, mais dans un style très différent.",
                      style: TextStyle(
                        color: Colors.white,
                      ),
                    ),
