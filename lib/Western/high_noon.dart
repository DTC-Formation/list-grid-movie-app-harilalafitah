...
class HighNoon extends StatefulWidget {
  const HighNoon({super.key});

  @override
  State<HighNoon> createState() => _HighNoonState();
}

class _HighNoonState extends State<HighNoon> {
  @override
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          Image.network(
                            'https://upload.wikimedia.org/wikipedia/commons/9/9c/Shane_%281953_poster%29.jpg',
                            fit: BoxFit.contain,
                            width: 120,
                            height: 150,
                          ),
